...
sensitivity_filename = 'raw_data/fourier_transformed_sensitivity_srgb.txt'
template_filename = 'FourierTransformedSpectralSensitivityDataNAME.cs.template'
output_filename = 'FourierTransformedSpectralSensitivityData' + NAME + '.cs'
