Shader "Hidden/HDRenderPipeline/preIntegratedVdotH_GGX"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 Frag(Varyings input) : SV_Target
            {
                ...
                float2 coordLUT = RemapHalfTexelCoordTo01(input.texCoord, VDOTHTEXTURE_RESOLUTION);
                ...
                float4 VdotH_moments = IntegrateGGXVdotH(NdotV, PerceptualRoughnessToRoughness(perceptualRoughness));

                return VdotH_moments;
            }
