Shader "Hidden/HDRenderPipeline/preIntegratedVdotL_GGX"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 Frag(Varyings input) : SV_Target
            {
                ...
                float2 coordLUT = RemapHalfTexelCoordTo01(input.texCoord, VDOTLTEXTURE_RESOLUTION);
                ...
                float4 VdotH_moments = IntegrateGGXVdotL(NdotV, PerceptualRoughnessToRoughness(perceptualRoughness));
