...
TEXTURE2D(_PreIntegratedVdotL_GGX);
...
void GetPreIntegratedVdotLGGX(float NdotV, float perceptualRoughness, out float4 VdotL_moments)
{
    ...
    VdotL_moments = SAMPLE_TEXTURE2D_LOD(_PreIntegratedVdotL_GGX, s_linear_clamp_sampler, coordLUT, 0);
}
